...
import com.example.vmfld.gonggumi.Adapter.MyPagerAdapter;
...
import com.example.vmfld.gonggumi.Fragment.OfficialMFragment;
import com.example.vmfld.gonggumi.Fragment.PersonalMFragment;
...
public class RoomActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txt_roomname = (TextView)findViewById(R.id.txt_t_roomname);
        // txt_roomname.setText("오사카 여행");
        txt_roomname.setText("제주도 여행");
       ...
       // viewPager.setAdapter(pagerAdapter);
        ...
        TextView txt_nav_roomname = (TextView)nav_header_view.findViewById(R.id.txt_nav_roomname);
        // txt_nav_roomname.setText("오사카 여행");
       txt_nav_roomname.setText("1월 부산 여행");
        //txt_nav_roomid.setText("No."+roomid);
        txt_nav_roomid.setText("No.122");
            ...
            public void onResponse(Call<PublicTabData> call, Response<PublicTabData> response) {
               ...
               // Log.e("RA_잘 들어왔나 확인 : ", publicTabDetailData.get().getMemo() + "");
                ...
                //txt_total_money.setText(temp_total+"원");
                 txt_total_money.setText("852,000원");
                // txt_total_money.setText("115,400원");
        ...
        if( requestCode == REQUEST_CODE_FINISH  &&  resultCode == RESULT_OK){
            ...
            call.enqueue(new Callback<PublicTabData>() {
                ...
                public void onResponse(Call<PublicTabData> call, Response<PublicTabData> response) {
                    ...
                    temp_check ++;
                    if(temp_check == 2){
                        txt_total_money.setText("855,000원");
                        RoomActivity.this.addPages();
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_divideMoney) {
            Intent intent = new Intent(RoomActivity.this, DivideActivity.class);
            intent.putExtra("temp_check", temp_check);
            intent.putExtra("roomid", roomid);
